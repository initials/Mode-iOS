...
//    FlxText * zoomInfo = [FlxText textWithWidth:FlxG.width
//                                 text:@"Game needs to be restarted for zoom setting to take effect"
//                                 font:nil
//                                 size:8];
//	zoomInfo.color = 0xffffffff;
//	zoomInfo.alignment = @"right";
//	zoomInfo.x = 0;
//	zoomInfo.y = FlxG.height-50;
//	[self add:zoomInfo];   
